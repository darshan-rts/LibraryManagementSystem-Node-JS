...
(Configure MySQL connection settings as needed for your environment.)
...
## Database setup
- Ensure MySQL is running and configure the connection settings in your .env file or directly in sql_db/db.js.
- Run any migrations or seed scripts included in the repo to set up the database schema.
